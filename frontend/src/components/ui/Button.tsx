...
export type ButtonVariant = 'primary' | 'secondary' | 'accent' | 'outline' | 'ghost' | 'mj' | 'wht' | 'danger';
...
const Button = ({
  ...
  const variantClasses = {
    ...
    danger: gradient
      ? 'bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white font-bold shadow-lg focus:ring-red-500'
