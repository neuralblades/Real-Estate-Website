        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/developers" className="text-gray-400 hover:text-white transition duration-300">
                  Developers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/properties?type=apartment" className="text-gray-400 hover:text-white transition duration-300">
                  Apartments
                </Link>
              </li>
              <li>
                <Link href="/properties?type=villa" className="text-gray-400 hover:text-white transition duration-300">
                  Villas
                </Link>
              </li>
              <li>
                <Link href="/properties?type=penthouse" className="text-gray-400 hover:text-white transition duration-300">
                  Penthouses
                </Link>
              </li>
              <li>
                <Link href="/properties?type=commercial" className="text-gray-400 hover:text-white transition duration-300">
                  Commercial
                </Link>
              </li>
            </ul>
